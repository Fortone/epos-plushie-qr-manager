...
export default function QrCodesPage() {
  ...
  // Group items by category if category information exists; otherwise put all under "All"
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-primary-dark mb-6 text-center">QR Codes</h2>
